...
$sql="UPDATE electrodomestico SET nombre='$nombre', modelo='$modelo',marca='$marca',fecha_entrada='$fecha_entrada',fecha_salida='$fecha_salida', estado='$estado', estado_garantia='$estado_garantia' , observaciones= '$observaciones', trabajo_a_realizar='$trabajo_a_realizar' WHERE idCliente='$idCliente' AND idElectrodomestico='$idElectrodomestico';";
